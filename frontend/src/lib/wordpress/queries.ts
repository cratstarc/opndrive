 ...
 * Type-safe queries for fetching blog content
 */
...
export const CATEGORY_FRAGMENT = `
  fragment CategoryFields on PostToCategoryConnection {
    nodes {
      id
      name
      slug
...
export const TAG_FRAGMENT = `
  fragment TagFields on PostToTagConnection {
    nodes {
      id
      name
      slug
...
/**
 * Fragment for Yoast SEO data
 * Works with Yoast SEO plugin via WPGraphQL Yoast SEO extension
 */
